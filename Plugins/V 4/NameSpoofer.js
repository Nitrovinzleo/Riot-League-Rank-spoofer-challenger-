...
(function () {
    ...
    /*** CONFIGURATION ***/
    const PSEUDO_ACTUEL = 'PrincessPinkyUp';
    const NOUVEAU_PSEUDO = 'LesbianPrincess';

    const TAGLINE_ACTUEL = 'PrincessPinkyUp#8ï8';
    const NOUVEAU_TAGLINE = 'LesbianPrincess#uwu';
